        ...
        <div className="BlogIndex">
            ...
            <div className="sec2">
                ...
                <p className="AlignLeft fs7 bold">
                    Anyone who is passionate for writing can
                    <br /> contribute to the LeoBlogs.
                </p>
                <br />
            ...
            <div className="sec3">
                ...
                <p className="AlignJustify fs5">
                    ...
                    world to come together and share what they have. As the
                    saying goes "Pen is more powerful than Sword", I believe
                    that using our digital pen and paper, you all will be able
                    to enlighten millions of young mind, eager to learn. Thus
                    keep supporting by writing your blogs and help us by
                    reporting the blogs that are inapproiate and have false
                    information. Hope you all have a great day.
                    <br />
                    <br />
                    Yours Faithfully,
                </p>
